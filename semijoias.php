					...
					<div class="col-12 mt-4">
						...
						<div class="row">
							...
							<div class="col-2 my-auto text-right">
								<a href="#login"><i class="fas fa-user text-white"></i></a>
							</div>
						</div>
					...
					<div class="col-12">
						...
						<div class="row">
							<div class="col-3">
								<div class="card mb-3">
									<div class="card-img-top">
										<img src="media/img/colar.jpg" class="w-100">
									</div>
							...
							<div class="col-3">
								<div class="card mb-3">
									<div class="card-img-top">
										<img src="media/img/colar1.jpg" class="w-100">
									</div>
									<div class="card-body">
							...
							<div class="col-3">
								<div class="card mb-3">
									<div class="card-img-top">
										<img src="media/img/brinco.jpg" class="w-100">
									</div>
									<div class="card-body">
							...
							<div class="col-3">
								<div class="card mb-3">
									<div class="card-img-top">
										<img src="media/img/conjunto1.jpg" class="w-100">
									</div>
									<div class="card-body">
